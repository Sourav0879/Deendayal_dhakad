...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002257424658'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002161709771'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002445720128')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002298764522').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002152956062').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002152956062').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://telegra.ph/file/939e6b66661e27c8b4d02.jpg')
OWNER_UPI_ID = environ.get('ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ', '@Sourav00876')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://daryllenicento:Cp7IfNCwEL9Idff2@cluster0.0gy8k.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002161709771'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_download_moviezone')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '9dd988a0552a97f798e7a811622c95b5a307dcb5')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_moviezone')  # Tutorial video link for opening shortlink website
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviefileshd1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Sourav00876')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/movieupdatechannel1')
OWNERID = int(os.environ.get('OWNERID', '7023006442'))  # Replace with the actual admin ID
